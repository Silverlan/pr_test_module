...
extern "C"
{
    ...
    DLLEXPORT bool pragma_attach(std::string &outErr)
    {
        ...
        Con::cout<<"Custom module \"pr_test_module\" has been loaded!"<<Con::endl;
        return true;
    }
    ...
    {
        Con::cout<<"Custom module \"pr_test_module\" is about to be unloaded!"<<Con::endl;
    }

    // Lua bindings can be initialized here
    DLLEXPORT void pragma_initialize_lua(Lua::Interface &lua)
    {
        auto &libDemo = lua.RegisterLibrary("pr_test_module");
